    ...
    */
    'rules' => [
        'civil_procedure.magistrate_claim_value' => [
            ...
            'prompt_guard_lines' => [
                'თუ კითხვა ეხება მაგისტრატ მოსამართლეს, სარჩელის ფასს, შეგებებულ სარჩელს ან საგნობრივ განსჯადობას, გამოიყენე სწორედ ეს civil procedure ჩარჩო.',
                'არ აურიო ეს საკითხი სააპელაციო საჩივრის დასაშვებობის ზღვართან ან სსკ 365-ე მუხლთან; ასეთი ანალოგია ამ პასუხში დაუშვებელია.',
            ],
        ...
        'civil_procedure.counterclaim_subject_matter_guard' => [
            ...
            'summary_lines' => [
                'სსკ 21: განსჯადობაზე შეთანხმება ეხება ტერიტორიულ განსჯადობას და არა საგნობრივ განსჯადობას.',
                'შეგებებული სარჩელის შეტანა არ ნიშნავს, რომ მხარეები საგნობრივ განსჯადობაზე შეთანხმდნენ.',
            ],
            'prompt_guard_lines' => [
                'შეგებებული სარჩელის დასაშვებობისას ცალკე შეამოწმე საგნობრივი განსჯადობა.',
            ],
        ...
        'civil_procedure.counterclaim_preparatory_stage_guard' => [
            ...
            'summary_lines' => [
                'სსკ 188: შეგებებული სარჩელის შეტანის ეტაპი ცალკე დასაშვებობის საკითხია.',
            ],
            'prompt_guard_lines' => [
                'მოსამზადებელ სხდომაზე შეტანის საკითხი არ აურიო საგნობრივი განსჯადობის ზღვართან.',
            ],
