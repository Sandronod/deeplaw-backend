...
class CanonicalLawResolverService
{
    ...
    private const DOMAIN_LAWS = [
        ...
        'labor'           => ['labor_code'],
        'privacy'         => ['personal_data_law'],
        'insolvency'      => ['insolvency_law'],
        'bankruptcy'      => ['insolvency_law'],
        'property'        => ['civil_code'],
        'family'          => ['civil_code'],
    ...
    private const ALIASES = [
        ...
        'პერსონალურ მონაცემთა დაცვის კანონ'  => 'personal_data_law',
        'პერსონალურ მონაცემთა დაცვ'          => 'personal_data_law',
        'მონაცემთა დაცვის კანონ'             => 'personal_data_law',
        'რეაბილიტაციისა და კრედიტორთა კოლექტიური დაკმაყოფილების შესახებ' => 'insolvency_law',
        'გადახდისუუნარობის კანონ'             => 'insolvency_law',
        'გადახდისუუნარობის შესახებ'           => 'insolvency_law',
        'გადახდისუუნარობ'                     => 'insolvency_law',
        'გაკოტრების კანონ'                    => 'insolvency_law',
        'საგ.კოდ'                           => 'tax_code',
